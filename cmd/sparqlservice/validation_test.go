...
func TestSemanticActionEndpoint_InvalidJSON(t *testing.T) {
	...
	if err == nil {
		t.Error("handleSemanticAction() should return error for invalid JSON")
	}
}
...
func TestSemanticActionEndpoint_EmptyBody(t *testing.T) {
	...
	if err == nil {
		t.Error("handleSemanticAction() should return error for empty body")
	}
}
...
func TestSemanticActionEndpoint_UnsupportedActionType(t *testing.T) {
	...
	if err == nil {
		t.Error("handleSemanticAction() should return error for unsupported action type")
	}
}
